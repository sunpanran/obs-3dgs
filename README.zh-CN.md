...
Dock 分为 **相机 / 场景 / 预设**三个页签。保存机位时打开 **预设 → 保存当前**，输入名称；选中预设后点击“应用”，或在 **OBS 设置 → 热键**中找到对应来源的 **3DGS：镜头预设 1–4** 来绑定按键。相机页的毫米数快捷项用于切换焦段。

自动来源支持群组和嵌套群组。可以选中群组内的 3DGS 来源，也可以选中只包含一个 3DGS 来源的群组；群组包含多个 3DGS 来源时，请展开群组选中具体来源，或在 Dock 顶部的来源下拉框中指定。
